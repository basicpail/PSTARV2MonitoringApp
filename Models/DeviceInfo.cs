...
namespace PSTARV2MonitoringApp.Models
{
    ...
    public static class DeviceInfo
    {
        ...
        {
            new DeviceModel("PSTAR-V2-5", "PSTAR V2 기본 모델"),
            new DeviceModel("PSTAR-V2-5H", "PSTAR V2 고온형 모델"),
            new DeviceModel("PSTAR-V2-5-S", "PSTAR V2 소형 모델"),
            new DeviceModel("PSTAR-V2-5H-S", "PSTAR V2 고온형 소형 모델"),
            new DeviceModel("PSTAR-V2-5-R", "PSTAR V2 원격 제어형 모델"),
            new DeviceModel("PSTAR-V2-5H-R", "PSTAR V2 고온형 원격 제어형 모델")
        };
